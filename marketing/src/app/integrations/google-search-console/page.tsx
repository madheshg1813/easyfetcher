...
const URL = `${SITE}/integrations/google-search-console`;

export const metadata: Metadata = {
  title: "Connect Search Console to AI with MCP | Easy Fetcher",
  description:
    "Connect Google Search Console to any MCP-compatible AI — Claude, ChatGPT, Perplexity, Cursor and more. Analyze clicks, impressions, queries and rankings in plain language.",
  alternates: { canonical: URL },
  openGraph: {
    title: "Connect Google Search Console to AI with MCP Server",
    description:
      "Give any MCP-compatible AI secure, read-only access to your Search Console data and analyze rankings with natural language.",
    url: URL,
    type: "website",
  },
};
...
const SKILLS: McpSkill[] = [
  { id: "seo-audit", name: "SEO Audit", body: "A prioritised crawl-and-score pass — titles, meta, indexability and on-page issues, ranked by impact.", href: "/skills/seo-audit" },
...
const PROMPTS = [
  ...
  "Show me pages that lost the most clicks this month",
  "Find keywords with high impressions but low CTR",
  "What are my top queries by clicks and position?",
  "Compare clicks and impressions vs last month",
...
const FEATURES = [
  ...
  { icon: Zap, title: "Real-time data", body: "Every answer is pulled live from the Search Console API when you ask — never a stale export." },
  { icon: Search, title: "Full GSC data", body: "Clicks, impressions, CTR, average position, queries, pages, countries and devices." },
...
const FAQS: Qa[] = [
  { q: "What is a Google Search Console MCP?", a: "A Search Console MCP is a connector built on the Model Context Protocol (MCP) that gives an AI assistant secure, read-only access to your Google Search Console data. Tools like Claude, ChatGPT and Cursor can then read your real clicks, impressions, queries and rankings and answer questions about them. Easy Fetcher hosts the MCP server for you — there's nothing to install or maintain." },
  { q: "How do I connect Search Console to AI with an MCP server?", a: "Create a free Easy Fetcher account, copy your Search Console MCP URL, and paste it into your AI tool's connector settings. Then sign in with Google and choose the verified property you want to read. The whole setup takes under two minutes — no API keys and no code." },
  { q: "Which AI platforms support the Search Console MCP?", a: "Any MCP-compatible client. That includes Claude, Claude Code, ChatGPT, Codex, Perplexity, Cursor and Gemini CLI, plus other tools that support the Model Context Protocol. You connect once with Easy Fetcher and use the same server across all of them." },
  { q: "What Search Console data can the AI access?", a: "The MCP can read clicks, impressions, CTR and average position, broken down by query, page, country and device, plus indexing and sitemap information. Access is read-only, so it can view your Search Console data but never change anything." },
  { q: "Can I find keyword and ranking opportunities with it?", a: "Yes. Because the AI reads your live query data, you can ask things like “which keywords have high impressions but low CTR?” or “what am I ranking on page 2 for?” — surfacing quick-win opportunities without exporting a single row." },
  { q: "Is my Search Console data safe with the Easy Fetcher MCP?", a: "Yes. The connection is read-only through Google OAuth, tokens are encrypted at rest, and your data is never used to train AI models. You can revoke access at any time from your Easy Fetcher dashboard or directly in your Google account." },
  { q: "Do I need to write code or an API key to use it?", a: "No. There are no API keys to generate and nothing to deploy. You sign in with Google, pick your verified property, and paste one connector URL into your AI tool — no developer setup required." },
  { q: "Is the Search Console MCP free to use?", a: "Creating an Easy Fetcher account and connecting your Search Console property is free. Running the MCP on your data uses an Easy Fetcher plan, which sets your monthly usage limit and how many properties you can connect — so you can start small and scale up." },
];

export default function SearchConsoleMcpPage() {
  ...
  const breadcrumbSchema = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Search Console MCP", item: URL },
  ] };
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-gray-200 mb-5">
            ...
            <img src={IMAGES.connectors.gsc} alt="" width={16} height={16} decoding="async" className="w-4 h-4 object-contain" />
            <span className="text-xs font-semibold text-gray-600">Google Search Console</span>
          </div>
          <h1 className="text-4xl sm:text-5xl lg:text-[54px] font-extrabold text-gray-900 leading-[1.08] tracking-[-0.02em] mb-5">
            Connect Search Console to AI with MCP Server
          </h1>
          <p className="text-base sm:text-lg lg:text-xl text-gray-500 leading-relaxed max-w-2xl mx-auto mb-8">
            Give any MCP-compatible AI secure, read-only access to your Search Console data. Ask about
            clicks, queries and rankings in plain language — and get answers from your real search
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-5">
            {[
              ...
              ["Connect Google", "Sign in with Google and pick the verified Search Console property to read. Read-only."],
              ["Start chatting", "Ask about clicks, queries or rankings and get answers from your live data."],
            ].map(([t, b], i) => (
      ...
      <McpSkillCards
        title="Search Console skills that run on this MCP"
      ...
      <section className="py-14 sm:py-16 px-4 sm:px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 tracking-tight leading-tight">Search Console MCP, answered</h2>
          </div>
      ...
      <section className="py-14 sm:py-16 px-4 sm:px-6" style={{ background: "linear-gradient(135deg, #171717 0%, #050505 50%, #171717 100%)" }}>
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight leading-tight mb-4">Connect Search Console to your AI</h2>
