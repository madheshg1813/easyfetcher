...
function FaqAccordion() {
  ...
  return (
    <div className="divide-y divide-gray-100/80 border border-gray-100/80 rounded-2xl overflow-hidden shadow-sm">
      {faqs.map((faq, i) => (
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      {/* Hero */}
      <section className="pt-14 sm:pt-20 lg:pt-28 pb-20 sm:pb-24 px-4 sm:px-6" style={{ background: "linear-gradient(180deg, #fffdf5 0%, #fffbeb 40%, #ffffff 100%)" }}>
        <div className="max-w-5xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-gray-900 leading-[1.08] tracking-[-0.02em] mb-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-8 lg:mb-10">
            <Link
              href={SIGNUP_URL}
              className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 lg:px-10 py-3.5 lg:py-4 rounded-xl bg-[#0e1b2f] text-white font-bold text-base lg:text-lg hover:bg-[#1c3050] transition-all shadow-lg shadow-[#0e1b2f]/20 hover:shadow-xl hover:shadow-[#0e1b2f]/25 hover:-translate-y-px"
            >
              Get Started <ArrowRight className="w-4 h-4 lg:w-5 lg:h-5" />
            </Link>
            <a
              href="#features"
              className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 lg:px-10 py-3.5 lg:py-4 rounded-xl border border-gray-200 bg-white text-gray-700 font-bold text-base lg:text-lg hover:border-gray-300 hover:shadow-md transition-all hover:-translate-y-px"
            >
              Browse SEO Skills
            </a>
          </div>
        ...
        <div className="max-w-2xl lg:max-w-3xl mx-auto mt-14 lg:mt-16">
          <div className="rounded-2xl border border-gray-200/80 bg-white shadow-2xl shadow-gray-200/60 overflow-hidden ring-1 ring-gray-100">
            {/* Window chrome */}
            ...
            <div className="p-4 sm:p-6 space-y-4 bg-white">
              ...
              <div className="flex gap-3 items-start flex-row-reverse">
                ...
                <div className="bg-amber-50 border border-amber-100 rounded-2xl rounded-tr-none px-4 py-4 text-sm text-gray-700 w-full max-w-sm sm:max-w-md space-y-3">
                  ...
                  <button className="w-full mt-1 py-2.5 px-4 rounded-xl bg-[#0e1b2f] text-white text-xs font-bold hover:bg-[#1c3050] transition-all flex items-center justify-center gap-1.5 shadow-sm">
      ...
      {/* Stats */}
      <section className="py-14 sm:py-16 px-4 sm:px-6 border-y border-gray-100/80 bg-white">
      ...
      {/* Why Easy Fetcher */}
      <section id="features" className="py-16 sm:py-28 px-4 sm:px-6 relative overflow-hidden" style={{ background: "linear-gradient(180deg, #fffdf5 0%, #fffbeb 50%, #ffffff 100%)" }}>
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-14 sm:mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight mb-5 leading-tight">
              Do SEO like an Expert Using AI
            </h2>
            <p className="text-base sm:text-lg lg:text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">
              Your real marketing data, connected to the AI tools you already use. No coding, no spreadsheets.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
            {/* Card 1 — Connect in 2mins */}
            <div className="group rounded-2xl border border-gray-100/80 bg-white p-6 sm:p-8 hover:border-amber-200 hover:shadow-xl hover:shadow-amber-100/40 transition-all duration-300 hover:-translate-y-0.5">
              <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-amber-50 group-hover:bg-amber-100 flex items-center justify-center shrink-0 transition-colors mb-4">
                <Clock className="w-5 h-5 sm:w-6 sm:h-6 text-amber-500" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-1.5 tracking-tight">Connect in 2 Minutes</h3>
              <p className="text-gray-500 leading-relaxed text-sm">
                Link your Google Search Console, GA4, and other data sources instantly. No API keys to hunt, no developer needed — just OAuth and you&apos;re live.
              </p>
            </div>
            ...
            <div className="group rounded-2xl border border-gray-100/80 bg-white p-6 sm:p-8 hover:border-amber-200 hover:shadow-xl hover:shadow-amber-100/40 transition-all duration-300 hover:-translate-y-0.5">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-1.5 tracking-tight">SEO Audit with Real Data from GSC & GA4</h3>
              <p className="text-gray-500 leading-relaxed text-sm">
                Run comprehensive SEO audits using our expert-built skills — powered by your actual Search Console and Analytics data. No guesswork, just actionable insights.
              </p>
            </div>

            {/* Card 3 — Reports & Dashboards */}
            <div className="group rounded-2xl border border-gray-100/80 bg-white p-6 sm:p-8 hover:border-amber-200 hover:shadow-xl hover:shadow-amber-100/40 transition-all duration-300 hover:-translate-y-0.5">
              <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-amber-50 group-hover:bg-amber-100 flex items-center justify-center shrink-0 transition-colors mb-4">
                <BarChart2 className="w-5 h-5 sm:w-6 sm:h-6 text-amber-500" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-1.5 tracking-tight">Generate SEO Reports & Dashboards for Clients</h3>
              <p className="text-gray-500 leading-relaxed text-sm">
                Create polished, client-ready SEO reports and dashboards in seconds. Share rankings, traffic trends, and opportunities — no manual slide decks needed.
              </p>
            </div>

            {/* Card 4 — Deep Dive Analytics */}
            <div className="group rounded-2xl border border-gray-100/80 bg-white p-6 sm:p-8 hover:border-amber-200 hover:shadow-xl hover:shadow-amber-100/40 transition-all duration-300 hover:-translate-y-0.5">
              <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-amber-50 group-hover:bg-amber-100 flex items-center justify-center shrink-0 transition-colors mb-4">
                <TrendingUp className="w-5 h-5 sm:w-6 sm:h-6 text-amber-500" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-1.5 tracking-tight">Deep Dive into Analytics</h3>
              <p className="text-gray-500 leading-relaxed text-sm">
                Got a question? Just ask. Explore traffic drops, keyword performance, page-level metrics, and get answers from your real data in plain English.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* How it works */}
      <section className="py-16 sm:py-28 px-4 sm:px-6" style={{ background: "linear-gradient(180deg, #fffdf5 0%, #fffbeb 100%)" }}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            {/* Step 01 */}
            <div className="relative bg-white rounded-2xl p-6 sm:p-7 border border-gray-100/80 shadow-md shadow-amber-100/20">
            ...
            <div className="relative bg-white rounded-2xl p-6 sm:p-7 border border-gray-100/80 shadow-md shadow-amber-100/20">
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div key={prompt} className="flex items-center gap-2 bg-amber-50/80 border border-amber-100 rounded-xl px-3 py-2">
            ...
            {/* Step 03 */}
            <div className="bg-white rounded-2xl p-6 sm:p-7 border border-gray-100/80 shadow-md shadow-amber-100/20">
      ...
      {/* Connectors */}
      <section id="connectors" className="py-16 sm:py-28 px-4 sm:px-6 bg-white">
      ...
      {/* Testimonials */}
      <section id="testimonials" className="py-16 sm:py-28 px-4 sm:px-6" style={{ background: "linear-gradient(180deg, #fffdf5 0%, #fffbeb 100%)" }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            {testimonials.map((t) => (
              <div key={t.name} className="bg-white rounded-2xl p-5 sm:p-7 border border-gray-100/80 shadow-md shadow-gray-100/30 flex flex-col gap-4 sm:gap-5 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-full bg-gradient-to-br from-amber-100 to-amber-200 flex items-center justify-center text-sm font-extrabold text-amber-600">
                    {t.name[0]}
                  </div>
                  <div>
      ...
      {/* Pricing */}
      <section id="pricing" className="py-16 sm:py-28 px-4 sm:px-6 bg-gray-50/50">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Try Plan banner */}
          <div className="mb-8 rounded-2xl border border-amber-200/80 bg-gradient-to-r from-amber-50/60 to-amber-50/30 p-5 sm:p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {PLANS.map((plan) => {
              ...
              return (
                <div
                  key={plan.id}
                  className={`relative rounded-2xl border bg-white flex flex-col p-7 transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5 ${
                    plan.highlight
                ...
                >
                  {plan.highlight && (
                    <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
                      <span className="flex items-center gap-1 px-4 py-1.5 rounded-full bg-[#0e1b2f] text-white text-[10px] font-extrabold whitespace-nowrap shadow-md shadow-[#0e1b2f]/20">
                  ...
                  <a
                    href={checkoutUrl}
                    className={`w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl font-bold text-sm transition-all hover:-translate-y-px ${
                      plan.highlight
      ...
      {/* CTA Banner */}
      <section className="py-16 sm:py-28 px-4 sm:px-6 relative overflow-hidden" style={{ background: "linear-gradient(135deg, #0e1b2f 0%, #0a1524 50%, #0e1b2f 100%)" }}>
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 sm:px-10 py-3.5 sm:py-4 rounded-xl bg-white text-[#0e1b2f] font-bold text-base hover:bg-gray-50 transition-all shadow-lg shadow-black/15 hover:shadow-xl hover:-translate-y-px"
            >
