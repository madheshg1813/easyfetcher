...
const connectors = [
  ...
  { name: "Google My Business", logo: "/connectors/google-my-business.svg", plan: "Pro", comingSoon: true },
  { name: "Google Ads", logo: "/connectors/icons8-google-ads.svg", plan: "Pro", comingSoon: true },
  { name: "Facebook Ads", logo: "/connectors/facebook.svg", plan: "Pro", comingSoon: true },
  { name: "Instagram Insights", logo: "/connectors/instagram.svg", plan: "Pro", comingSoon: true },
  { name: "LinkedIn Ads", logo: "/connectors/linkedin.svg", plan: "Pro", comingSoon: true },
  { name: "TikTok Ads", logo: "/connectors/tiktok.svg", plan: "Pro", comingSoon: true },
];
      ...
      <section id="connectors" className="py-16 sm:py-24 px-4 sm:px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-base sm:text-lg text-gray-500">More connectors added every month.</p>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 sm:gap-4">
            {connectors.map((c) => (
              <div key={c.name} className="group relative flex flex-col items-center gap-2.5 sm:gap-3 p-4 sm:p-5 rounded-2xl border border-gray-100 hover:border-amber-200 hover:shadow-md hover:shadow-blue-50/50 transition-all bg-white cursor-default">
                {c.comingSoon && (
                  <span className="absolute -top-2.5 left-1/2 -translate-x-1/2 text-[9px] px-2 py-0.5 rounded-full font-bold tracking-wide bg-gray-100 text-gray-400 border border-gray-200 whitespace-nowrap">
                    Coming Soon
                  </span>
                )}
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={c.logo} alt={c.name} className={`w-9 h-9 sm:w-10 sm:h-10 object-contain ${c.comingSoon ? "opacity-50 grayscale" : ""}`} />
                <span className={`text-xs font-semibold text-center leading-tight ${c.comingSoon ? "text-gray-400" : "text-gray-700"}`}>{c.name}</span>
                <span className={`text-[10px] px-2 sm:px-2.5 py-1 rounded-full font-semibold tracking-wide ${
                  c.comingSoon
            ...
            <div className="flex flex-col items-center justify-center gap-2 p-4 sm:p-5 rounded-2xl border border-dashed border-gray-200 text-gray-300">
